...
For fitting, use the _ctmcFit_ function. It returns the MLE values for the parameters along with the confidence intervals.
```{r ctmcFitting, echo = TRUE, message=FALSE, warning=FALSE}
